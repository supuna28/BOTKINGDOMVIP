...
END:VCARD
        ...
        processMessageStubType: {
            ...
            async value(m) {
                ...
                console.log(`Process MessageStubType (${chat})`)
                ...
                console.log(`Update ${chat} chat due to MessageStubType`)
            }
        },
        insertAllGroup: {
            async value() {
                ...
                console.log(`Insert ${Object.keys(groups).length} groups to 'chats'`)
                return conn.chats
            },
        },
        pushMessage: {
            ...
            async value(m) {
                ...
                console.log(`Got ${m.length} message(s)`)
                for (const message of m) {
                    try {
                        // if (!(message instanceof proto.WebMessageInfo)) continue // https://github.com/adiwajshing/Baileys/pull/696/commits/6a2cb5a4139d8eb0a75c4c4ea7ed52adc0aec20f
                        if (!message) continue
                        console.log({ WebMessageInfo: message instanceof proto.WebMessageInfo })
                        ...
                        console.log(`Process message (${message.key?.id})`)
                        if (message.message?.[mtype]?.contextInfo?.quotedMessage) {
                            ...
                            if ((remoteJid && remoteJid !== 'status@broadcast') && quoted) {
                                console.log(`Process quoted message (${context.stanzaId})`)
                                ...
                                console.log(`Insert quoted message (${context.stanzaId}) to 'chats'`)
                                let qChatsMessages
                        ...
                        if (!['protocolMessage'].includes(mtype) && !fromMe && message.messageStubType != WAMessageStubType.CIPHERTEXT && message.message) {
                            ...
                            console.log(`Insert messsage (${message.key.id}) to 'chats'`)
                            let chatsMessages
    ...
    return Object.defineProperties(proto.WebMessageInfo.prototype, {
        ...
        getQuotedObj: {
            async value() {
                ...
                const q = proto.WebMessageInfo.fromObject(await this.conn.loadMessage(this.quoted.id).catch(_ => null) || this.quoted.vM)
